...
public abstract class BaseMeasurableViewGroup extends ViewGroup {
	...
	public BaseMeasurableViewGroup(IWidget widget) {
		this.widget = widget;
	...
	protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
	    ...
	    if (heightMode == MeasureSpec.EXACTLY) {
	        ...
	        height = Math.max(height, getDrawableHeight(leftDrawable));
	        height = Math.max(height, getDrawableHeight(rightDrawable));
    ...
    public RectM getWidgetBounds(int width, int height, Object... nativeWidgets) {
	    ...
	    return new RectM(compoundPaddingLeft, compoundPaddingTop + alignY, width - compoundPaddingLeft - compoundPaddingRight, boundHeight);
    }
	...
	public RectM getRightDrawableBounds(int x, int y, int width, int height) {
		if (rightDrawable != null) {
			...
			int dy = getPaddingTop();
			int dx = width - dWidth - getPaddingRight();
