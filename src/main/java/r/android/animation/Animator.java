...
import r.android.annotation.TestApi;
import r.android.compat.annotation.UnsupportedAppUsage;
import r.android.content.pm.ActivityInfo.Config;
import r.android.content.res.ConstantState;
import r.android.os.Build;
import r.android.util.LongArray;
...
public abstract class Animator implements Cloneable {
     ...
     * {@link r.android.animation.Animator.AnimatorListener#onAnimationEnd(Animator)} message.
     *
     ...
     * default value is {@link r.android.view.animation.AccelerateDecelerateInterpolator}.
     *
     ...
     * r.android.view.View, int, int, float, float) createCircularReveal()}),
     ...
     * {@link r.android.content.pm.ActivityInfo}.
     * @see r.android.content.pm.ActivityInfo
     * @hide
     */
     ...
     * defined by {@link r.android.content.pm.ActivityInfo}.
     *
     * @see r.android.content.pm.ActivityInfo
     * @hide
     */
     ...
     * @see r.android.content.res.ConstantState
     * @see #clone()
     * @hide
     */
