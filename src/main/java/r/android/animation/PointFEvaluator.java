...
public class PointFEvaluator implements TypeEvaluator<PointF> {
   ...
   /**
     ...
     * {@link #evaluate(float, r.android.graphics.PointF, r.android.graphics.PointF)} should
   ...
   /**
     ...
     * (x, y).
     *
     * <p>If {@link #PointFEvaluator(r.android.graphics.PointF)} was used to construct
