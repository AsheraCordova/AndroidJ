...
import r.com.android.internal.util.FastMath;
...
public class RectF implements Parcelable {
   ...
   /**
    ...
    public static final @r.android.annotation.NonNull Parcelable.Creator<RectF> CREATOR = new Parcelable.Creator<RectF>() {
       /**
