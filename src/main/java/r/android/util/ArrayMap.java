...
public final class ArrayMap<K, V> implements Map<K, V> {
    ...
    private final class ArraMapMapCollections extends MapCollections<K, V> {
		@Override
   ...
   /**
    ...
    private ArrayMap(boolean immutable) {
        ...
        mHashes = immutable ? EMPTY_IMMUTABLE_INTS : new int[0];
        mArray = new Object[0];
        mSize = 0;
    }
   ...
   /**
    ...
    private MapCollections<K, V> getCollection() {
        if (mCollections == null) {
            mCollections = new ArraMapMapCollections();
        }
        return mCollections;
    }
