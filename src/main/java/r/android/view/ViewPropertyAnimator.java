...
import r.android.annotation.FloatRange;
import r.android.annotation.NonNull;
import r.android.annotation.Nullable;
//import r.android.graphics.RenderNode;
 ...
 * {@link r.android.animation.ObjectAnimator} is fine; the property setters called by ObjectAnimator
 ...
 * it will animate. Calls to {@link r.android.view.View#animate()} will return a reference
...
public class ViewPropertyAnimator {
     ...
     *
     * @see r.android.animation.ValueAnimator.AnimatorUpdateListener
     *
     ...
     * {@link View#setLayerType(int, r.android.graphics.Paint) layer type} set to
     ...
     * the View (by a direct call to {@link View#setLayerType(int, r.android.graphics.Paint)}) will
     ...
     *
     * @see View#setLayerType(int, r.android.graphics.Paint)
     * @return This object, allowing calls to methods in this class to be chained.
     */
    public @NonNull ViewPropertyAnimator withLayer() {
        ...
        final int currentLayerType = 0;//mView.getLayerType();
    ...
    private void setValue(int propertyConstant, float value) {
        ...
        switch (propertyConstant) {
            ...
            case Y:
                ...
                break;
            case Z:
                mView.setTranslationZ(value - mView.getElevation());
                break;
            case ALPHA:
