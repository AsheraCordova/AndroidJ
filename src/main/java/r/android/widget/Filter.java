...
import r.android.os.HandlerThread;
import r.android.os.Looper;
 ...
 *
 * <p>Filters are usually created by {@link r.android.widget.Filterable}
 * classes.</p>
 *
 * <p>Filtering operations performed by calling {@link #filter(CharSequence)} or
 * {@link #filter(CharSequence, r.android.widget.Filter.FilterListener)} are
 ...
 *
 * @see r.android.widget.Filterable
 */
public abstract class Filter {
     ...
     *
     * @see #filter(CharSequence, r.android.widget.Filter.FilterListener)
     */
     ...
     * @see #publishResults(CharSequence, r.android.widget.Filter.FilterResults)
     */
    public final void filter(CharSequence constraint, FilterListener listener) {
        synchronized (mLock) {
            mThreadHandler = new RequestHandler(Looper.getMainLooper());if (mThreadHandler == null) {
     ...
     * must be returned as a {@link r.android.widget.Filter.FilterResults} that
     * will then be published in the UI thread through
     * {@link #publishResults(CharSequence,
     * r.android.widget.Filter.FilterResults)}.</p>
     *
     ...
     * @see #filter(CharSequence, r.android.widget.Filter.FilterListener)
     * @see #publishResults(CharSequence, r.android.widget.Filter.FilterResults)
     * @see r.android.widget.Filter.FilterResults
     */
     ...
     * {@link r.android.widget.Filter#filter(CharSequence, r.android.widget.Filter.FilterListener)},
    ...
    private class ResultsHandler extends Handler {
         ...
         * r.android.widget.Filter.FilterResults)}
    ...
    public interface Delayer {
         ...
         *         {@link Handler#sendMessageDelayed(r.android.os.Message, long)}
         */
