...
public class BezierListProducer implements PathHandler {
    ...
    @Override
    public void startPath() throws BezierParseException {
    	curveLength = 0f;
    	bezierSegs.clear();
    }

    @Override
    public void movetoRel(float x, float y) throws BezierParseException {
    ...
    @Override
    public void movetoAbs(float x, float y) throws BezierParseException {
    	hist.setLastPoint(x, y);
    }

    @Override
    public void closePath() throws BezierParseException {
    	linetoRel(hist.startPoint.x, hist.startPoint.y);
    }

    @Override
    public void linetoRel(float x, float y) throws BezierParseException {
    	float offx = hist.lastPoint.x;
        float offy = hist.lastPoint.y;
    ...
    @Override
    public void linetoAbs(float x, float y) throws BezierParseException {
    ...
    @Override
    public void linetoHorizontalRel(float x) throws BezierParseException {
    	linetoAbs(x + hist.lastPoint.x, hist.lastPoint.y);
    }

    @Override
    public void linetoHorizontalAbs(float x) throws BezierParseException {
    	linetoAbs(x, hist.lastPoint.y);
    }

    @Override
    public void linetoVerticalRel(float y) throws BezierParseException {
    	linetoAbs(hist.lastPoint.x, y + hist.lastPoint.y);
    }

    @Override
    public void linetoVerticalAbs(float y) throws BezierParseException {
    ...
    @Override
    public void endPath() throws BezierParseException {
