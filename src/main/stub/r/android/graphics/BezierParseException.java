...
public class BezierParseException extends RuntimeException {
     ...
     */
    public BezierParseException (String message, int line, int column) {
        super(message);
        exception = null;
        lineNumber = line;
        columnNumber = column;
     ...
     */
    public BezierParseException (Exception e) {
        exception = e;
        lineNumber = -1;
        columnNumber = -1;
    }
     ...
     */
    public BezierParseException (String message, Exception e) {
        super(message);
        this.exception = e;
    }
